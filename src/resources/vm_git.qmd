...
### Acessing the organization
Scan the following QR code and type your username to be sent an invite to the Github organization
![](../weeks/figures/week-0/qr.png){width="40%"  style="display:block; margin:auto;"}
Or use [this link](https://githuborganizationadderdeploy.vercel.app)
